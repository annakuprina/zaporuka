  ...
  <div class="help_form_wrapper">
  	<div class="help-form-inner-wrapper">
	   ...
	   <form action="/wp-content/plugins/liqpay_wordpress/liqpay-form.php" method="POST" class="help_form">
		   	...
		   	<input type="hidden" name="hidden_content"  value="<?php echo site_url('/storinka-podyaky/new-order');?>"/>
		   	<input type="hidden" name="url_page"  value="<?php echo site_url('/storinka-podyaky/new-order');?>"/>
