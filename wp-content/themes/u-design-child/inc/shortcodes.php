...
$payonce_label = !empty($options['payonce_help_block_' . ICL_LANGUAGE_CODE]) ? $options['payonce_help_block_' . ICL_LANGUAGE_CODE] : 'Одноразове пожертвування в БФ Запорука';
$monthly_label = !empty($options['monthly_help_block_' . ICL_LANGUAGE_CODE]) ? $options['monthly_help_block_' . ICL_LANGUAGE_CODE] : 'Щомісячне перерахування коштів в БФ Запорука';
