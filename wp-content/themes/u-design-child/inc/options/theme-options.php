    ...
    $sections[] = array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'text',
                'title' => __('Секция 1', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_ru',
                'type' => 'text',
                'title' => __('Секция 1 (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_text_ru',
                'type' => 'text',
                'title' => __('Секция 1 текст ссылки (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_ru',
                'type' => 'text',
                'title' => __('Секция 1 ссылка (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_uk', //17
                'type' => 'text',
                'title' => __('Секция 1 (ua)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_uk',
                'type' => 'text',
                'title' => __('Секция 1 (ховер) (ua)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_text_uk',
                'type' => 'text',
                'title' => __('Секция 1текст ссылки (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_uk',
                'type' => 'text',
                'title' => __('Секция 1 ссылка (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_en', //18
                'type' => 'text',
                'title' => __('Секция 1 (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_en',
                'type' => 'text',
                'title' => __('Секция 1 (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_text_en',
                'type' => 'text',
                'title' => __('Секция 1 текст ссылки (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_partner_hover_link_en',
                'type' => 'text',
                'title' => __('Секция 1 ссылка (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Секция 2 текст ссылки (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_link_ru',
                'type' => 'text',
                'title' => __('Секция 2 ссылка (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_uk', //20
                'type' => 'text',
                'title' => __('Секция 2 (ua)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_uk',
                'type' => 'text',
                'title' => __('Секция 2 (ховер) (ua)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_link_text_uk',
                'type' => 'text',
                'title' => __('Секция 2 текст ссылки (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_link_uk',
                'type' => 'text',
                'title' => __('Секция 2 ссылка (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_en', //21
                'type' => 'text',
                'title' => __('Секция 2 (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_en',
                'type' => 'text',
                'title' => __('Секция 2 (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_link_text_en',
                'type' => 'text',
                'title' => __('Секция 2 текст ссылки (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'become_volunteer_hover_link_en',
                'type' => 'text',
                'title' => __('Секция 2 ссылка (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Секция 3 (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Секция 3 (ua)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'help_by_sms_hover_uk',
                'type' => 'text',
                'title' => __('Секция 3 ховер (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'help_by_sms_hover_text_link_uk',
                'type' => 'text',
                'title' => __('Секция 3 текст ссылки (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Секция 3 ховер (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
            ...
            array(
                'id' => 'charity_shop_ru',
                'type' => 'text',
                'title' => __('Секция 4 (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_ru',
                'type' => 'text',
                'title' => __('Секция 4 (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_text_ru',
                'type' => 'text',
                'title' => __('Секция 4 текст ссылки (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_ru',
                'type' => 'text',
                'title' => __('Секция 4 ссылка (ховер) (ru)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_uk',
                'type' => 'text',
                'title' => __('Секция 4 (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_uk',
                'type' => 'text',
                'title' => __('Секция 4 (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_text_uk',
                'type' => 'text',
                'title' => __('Секция 4 текст ссылки (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_uk',
                'type' => 'text',
                'title' => __('Секция 4 ссылка (ховер) (uk)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_en',
                'type' => 'text',
                'title' => __('Секция 4 (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_en',
                'type' => 'text',
                'title' => __('Секция 4 (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_text_en',
                'type' => 'text',
                'title' => __('Секция 4 текст ссылки (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => 'charity_shop_hover_link_en',
                'type' => 'text',
                'title' => __('Секция 4 ссылка (ховер) (en)', 'nhp-opts'),
                'std' => __('', 'nhp-opts'),
            ),
            array(
                'id' => '58',
