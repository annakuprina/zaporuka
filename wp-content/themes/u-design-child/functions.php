...
add_action('init', function() {
  ...
  pll_register_string('liqpay_wordpress', 'Вітаємо! Ваш платіж пройшов успішно');
  pll_register_string('liqpay_wordpress', 'платіж відхилено');
  pll_register_string('liqpay_wordpress', 'Вибачте але Ваш платіж відхилено');
  pll_register_string('liqpay_wordpress', 'Дата/час');
  ...
  pll_register_string('liqpay_wordpress', 'Вартiсть');
  pll_register_string('liqpay_wordpress', "Им'я");
  pll_register_string('liqpay_wordpress', 'Телефон');
  pll_register_string('liqpay_wordpress', 'Коментар');
  pll_register_string('liqpay_wordpress', 'платіж здійснено');
