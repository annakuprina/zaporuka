	...
	<footer id="footer-bg" class="wow fadeIn" data-wow-duration="0.5s" data-wow-delay="0.2s">
		...
		<div id="footer" class="container_24 footer-top">
			...
			<div id="footer_bottom">
				...
				<div class="one_fifth">
					<span class="developer"><span class="developer-text"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6"><g><g><path fill="#aaa" d="M0 .078h6v5.838H0z"/></g></g></svg>Developed by</span><a href="<?php echo $developer_link;?>" target="_blank" class="developer-link"><?php echo $developer_text;?></a></span>
				</div>
				<div class="one_fifth last_column">
