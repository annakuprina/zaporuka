		...
		if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( 'PortfolioSidebar' ) ) : 
			...
			if( ! empty( $portfolio_categories ) ) :
				...
				<div class="custom-formatting">
					...
					<ul>
						<li><?php _e( "To edit this sidebar, go to admin backend's <strong><em>Appearance -> Widgets</em></strong> and place widgets into the <strong><em>PortfolioSidebar</em></strong> Widget Area", 'u-design' ); ?></li>
					</ul>
				</div>
				<?php
			endif;
