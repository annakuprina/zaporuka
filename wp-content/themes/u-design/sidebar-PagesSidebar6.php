	...
	<div id="sidebarSubnav">
		...
		if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( 'PagesSidebar6' ) ) :
			...
			<div class="custom-formatting">
				...
				<ul>
					<li><?php _e( "To edit this sidebar, go to admin backend's <strong><em>Appearance -> Widgets</em></strong> and place widgets into the <strong><em>Pages Sidebar 6</em></strong> Widget Area", 'u-design' ); ?></li>
				</ul>
			</div>
			<?php
		endif;
