...
function udesign_icon_fonts_options_menu() {
	global $submenu;
	$udesign_icon_fonts_admin_page =  add_submenu_page('udesign_options_page', __( 'Icon Fonts', 'u-design' ), __( 'Icon Fonts', 'u-design' ), who_can_edit_udesign_theme_options(), 'udesign_icon_fonts_options_page', 'icon_fonts_options_page_callback');
        // Modify the default main page ("U-Design") submenu name
        if ( current_user_can( who_can_edit_udesign_theme_options() ) ) {
            $submenu['udesign_options_page'][0][0] = esc_attr__('Settings', 'u-design');
        }
...
function icon_fonts_options_page_callback() {
        ...
        if ( isset($_GET['settings-updated']) || isset($_GET['updated']) ) {
            ...
            if( isset( $udesign_icon_fonts_options['remove_fontello_folder'] ) && $udesign_icon_fonts_options['remove_fontello_folder'] == 'yes' ) {
                if ( udesign_is_fontello_installed() ) {
                    ...
                    <div class="error"><p><?php _e( "Nothing to delete! Fontello installation was not found.", 'u-design' ); ?></p></div><?php 
                }
            }
	...
	<div class="wrap">
            <h1><?php _e('U-Design Icon Fonts Options', 'u-design'); ?></h1>
            <?php // settings_errors(); ?>

	    <nav class="nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
                    <a href="?page=udesign_icon_fonts_options_page&tab=fontello" class="nav-tab <?php echo ( 'fontello' === $tab ) ? 'nav-tab-active' : ''; ?>"><?php echo 'Fontello'; ?></a>
                    <a href="?page=udesign_icon_fonts_options_page&tab=font_awesome" class="nav-tab <?php echo ( 'font_awesome' === $tab ) ? 'nav-tab-active' : ''; ?>"><?php echo 'Font Awesome'; ?></a>
            </nav>
...
<?php                           if ( udesign_is_fontello_installed() ) : ?>
                                    <label for="remove_fontello_folder" class="remove-fontello-folder">
                                        ...
                                        <?php esc_attr_e('Remove the Fontello Icon Fonts', 'u-design'); ?> &nbsp;&nbsp;
                                    </label>
                                    <div class="clear"></div>
                                    <span class="description" style="display:inline-block; margin:2px 0 10px"><?php esc_attr_e('Deleting or replacing the currently installed Fontallo icons would affect those icons used in your content, so don\'t forget to update your content accordingly.', 'u-design'); ?></span>
<?php                           endif; ?>
                                ...
                                <div class="fontello-submit">
                                    <input type="submit" name="fontello-submit" id="fontello-submit" 
                                           class="button button-primary udesign-left-submit-btn" 
                                                value="<?php esc_attr_e('Save Changes', 'u-design') ?>"  />
                                </div>
...
<?php           $demo_file_url = udesign_is_fontello_installed( 'demo.html' );
                if ( $demo_file_url ) : ?>
                    <div id="preview-fontello-fonts-section-wrapper">
                        <iframe id="test" src="<?php echo esc_url( $demo_file_url ); ?>" frameborder="0"  width="940" height="500"></iframe>
...
<?php       elseif ( $tab == 'font_awesome' ) : ?>
                ...
                <h3><?php esc_html_e('General Information', 'u-design'); ?></h3>
                <a href="<?php echo get_template_directory_uri(); ?>/inc/shared/documentation/index.html#icon-fonts" title="Open the documentation" target="_blank"><?php esc_html_e('Icon Fonts Documentation', 'u-design'); ?></a>
                <p>
<?php               esc_html_e('By default the theme comes with Font Awesome icons already preloaded, so you don\'t have to do anything to install the fonts.', 'u-design'); ?>
                </p>
                
                <p style="padding: 10px 0 0 40px;">
<?php               printf( esc_html__('For your reference a full list of all the FA icons can be found at %s', 'u-design'), 
                        '<a title="'.esc_html__('The Icons List', 'u-design').'" href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">http://fortawesome.github.io/Font-Awesome/icons/</a>' ); ?>
                </p>
...
<?php               printf( esc_html__('Here\'s some example uses from the Font Awesome website: %s', 'u-design'), 
                        '<a title="'.esc_html__('Font-Awesome Examples', 'u-design').'" href="http://fortawesome.github.io/Font-Awesome/examples/" target="_blank">http://fortawesome.github.io/Font-Awesome/examples/</a>' ); ?>
                </p>
                ...
                <h3><?php esc_html_e('Usage Instructions within WordPress and the uDesign theme', 'u-design'); ?></h3>
                <p>
<?php               printf( esc_html__('Within WordPress you can place Font Awesome icons just about anywhere with the %s tag.', 'u-design'), '<code>&lt;i&gt;</code>' ); ?>
                </p>
                <p>
<?php               esc_html_e('I have also provided a button in each post/page editor to insert icons in your content directly. This option will allow you to select, style and generate your code:', 'u-design'); ?>
                </p>
                <p style="padding: 10px 0 0 40px;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/add-icon-button.png" alt="select-icon-popup image" />
                </p>
                
                <h3><?php esc_html_e('The Shortcode', 'u-design'); ?></h3>
                <p>
<?php               esc_html_e('Font Awesome as well as Fontello icons can also be inserted in your content with a shortcode which is specific to the uDesign theme, example:', 'u-design'); ?>
                    <span style="display: block; margin:10px 10px 20px 20px;"><code>[udesign_icon_font name="fa fa-refresh"]</code></span>
                </p>
                <p>
<?php               esc_html_e('Specify the color:', 'u-design'); ?><br />
                    <span style="display: block; margin:10px 10px 20px 20px;"><code>[udesign_icon_font name="fa fa-refresh" color="#dd9933"]</code></span>
                </p>
                <p>
<?php               esc_html_e('To add animated spin use "fa-spin" for Font Awesome (and for Fontello icons use "animate-spin" instead):', 'u-design'); ?><br />
                ...
                <p>
<?php               esc_html_e('With "circle-wrap" added:', 'u-design'); ?><br />
                ...
                <p>
<?php               esc_html_e('The size can be specified in the following way:', 'u-design'); ?><br />
...
function udesign_icon_fonts_register_settings() {
	...
	add_settings_section('field_fontello_uploader', __( 'Fontello Icon Fonts Uploader', 'u-design' ), 'field_fontello_uploader_callback', 'udesign_icon_fonts_options');
	
	add_settings_field('icon_fonts_upload', __( 'Import the fonts:', 'u-design' ), 'icon_fonts_upload_button_callback', 'udesign_icon_fonts_options', 'field_fontello_uploader');
...
function udesign_font_awesome_register_settings() {
	...
	add_settings_section('field_font_awesome_options', __( 'Font Awesome Options', 'u-design' ), 'udesign_field_font_awesome_options_callback', 'udesign_font_awesome_options');
	
	add_settings_field('disable_font_awesome_checkbox', __( 'Disable Font Awesome', 'u-design' ), 'udesign_disable_font_awesome_checkbox_callback', 'udesign_font_awesome_options', 'field_font_awesome_options');
}
...
function field_fontello_uploader_callback() {
	echo '<p>'; ?>
        <a href="http://youtu.be/6zOJQBwnuhc" title="Video Tutorial" target="_blank"><?php esc_html_e('Video Tutorial', 'u-design'); ?></a> | 
        <a href="<?php echo get_template_directory_uri(); ?>/inc/shared/documentation/index.html#icon-fonts" title="Open the documentation" target="_blank"><?php esc_html_e('Icon Fonts Documentation', 'u-design'); ?></a>
        <div class="clear"></div> <?php 
        printf( esc_html__('Before you can use this section you will need to go to %s, choose the icon fonts you would like to include in the theme and then generate your zip file, upload the fontello zip file in the section below.', 'u-design'), 
                '<a title="'.esc_html__('Go to http://fontello.com/', 'u-design').'" href="http://fontello.com/" target="_blank">http://fontello.com/</a>' );
	echo '</p>';
}
// tab 'font_awesome'
function udesign_field_font_awesome_options_callback() {
	echo '<p>' . esc_html__('By default the Font Awesome fonts and styles are loaded within the theme. This means that the icons are available for your choosing in the page, post or anywhere else in your content. If you would like to remove Font Awesome from the available icon fonts, please use the option below to disable them:', 'u-design') . '</p>';
}
...
function icon_fonts_upload_button_callback() {
	$options = get_option('udesign_icon_fonts_options'); ?>
        ...
        <input id="icon_fonts_upload_button" type="button" value="<?php esc_attr_e('Upload Fontello "zip" File', 'u-design'); ?>" class="button-secondary" />
...
function udesign_disable_font_awesome_checkbox_callback() {
	$options = get_option('udesign_font_awesome_options'); ?>
        ...
        <label for="udesign_disable_font_awesome">
            ...
            <?php esc_html_e("This will remove, unload any styles or files associated with the Font Awesome icons from the theme.", 'u-design'); ?>
        </label>
        ...
        if ( $fontello_zip_file ) {
            ...
            if( ! $wp_filesystem->is_dir( $to ) ) {
                ...
                if ( ! $wp_filesystem->mkdir( $to ) ) { ?>
                        ...
                        <div class="error"><p><?php printf( __('uDesign Error: There was an error creating the %s folder', 'u-design'), $to ); ?></p></div>
                        <?php
                }
...
EOF;
            ...
            if( $result !== true ){
                ...
                <div class="error"><p><?php _e( "uDesign Error: Unzipping the Fontello file failed!", 'u-design' ); ?></p></div>
                <?php
                return false;
            }
        ...
        <div class="error"><p><?php _e( "uDesign Error: You don't have direct write permissions to the file system.", 'u-design' ); ?></p></div>
        <?php
        return false;
    }
    ...
    if ( $access_type === 'direct' ) {
        ...
        if( $wp_filesystem->is_dir( $fontello_folder ) ) {
            ...
            if ( ! $wp_filesystem->rmdir( $fontello_folder, true ) ) { ?>
                <div class="error"><p><?php printf( __('uDesign Error: Deletion of %s folder failed!', 'u-design'), $fontello_folder ); ?></p></div>
                <?php
                return false;
            }
...
function udesign_get_fontello_style_sheet( $css_file = 'fontello.css' ) {
    ...
    <div class="error"><p><?php printf( __('uDesign Error: %s file could not be found.', 'u-design'), $css_file ); ?></p></div><?php 
    return false;
}
...
function udesign_get_fontello_config_file() {
    ...
    if ( ! $fontello_config_file_contents ) {
        ?><div class="error"><p><?php _e( "uDesign Error: The Fontello config file has no content.", 'u-design' ); ?></p></div><?php 
        return false;
    }
    ...
    if ( ! is_array( $results ) ) { ?>
        <div class="error"><p><?php _e( "uDesign Error: There was an issue decoding the Fontello config file.", 'u-design' ); ?></p></div><?php 
        return false;
    }
