jQuery(function (g) {
  ...
  var v = {
      ...
      payment_method_selected: function (e) {
        ...
        i !== v.selectedPaymentMethod &&
          g(document.body).trigger("payment_method_selected"),
          (v.selectedPaymentMethod = i);
      },
      ...
      init_checkout: function () {
        g(function () {
          g(document.body).trigger("updated_checkout");
        });
      },
      ...
      init_ship_to_different_address: function () {
        var e = g("#ship-to-different-address input");
        if (!e.prop("checked")) {
          var t = g("div.woocommerce-billing-fields");
          0 <
            g("div.shipping_address")
              .find("input, select")
              .filter(function () {
                g(this).attr("id").replace("shipping", "billing");
                var e = g(this).attr("id").replace("shipping", "billing");
                return g(this).val() !== t.find("#" + e).val();
              }).length && e.prop("checked", !0);
        }
        g("div.shipping_address").toggle(e.prop("checked"));
      },
      ship_to_different_address: function () {
        g(this).is(":checked")
          ? g("div.shipping_address").slideDown()
          : g("div.shipping_address").slideUp();
      },
      ...
      update_checkout_action: function (e) {
        if ((v.xhr && v.xhr.abort(), 0 !== g("form.checkout").length)) {
          ...
          var t = g("#billing_country").val(),
            ...
            i = g(":input#billing_postcode").val(),
            c = g("#billing_city").val(),
          ...
          p.length &&
            ...
            g("#ship-to-different-address").find("input").is(":checked") &&
              ...
              (d = g("#shipping_state").val()),
              (u = g(":input#shipping_postcode").val()),
      ...
      submit: function () {
        ...
        return (
          e.is(".processing") ||
            (!1 !== e.triggerHandler("checkout_place_order") &&
              !1 !==
                e.triggerHandler(
    ...
    e = {
      ...
      remove_coupon: function (e) {
        ...
        var i = { security: wc_checkout_params.remove_coupon_nonce, coupon: o };
        g.ajax({
          type: "POST",
          url: wc_checkout_params.wc_ajax_url
            .toString()
